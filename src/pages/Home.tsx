    ...
    return (
        <>
            ...
            <Suspense fallback={<SectionLoader />}>
                {/* Problem Section */}
                <article id="problem" aria-labelledby="problem-heading" itemScope itemType="https://schema.org/Article">
                    <TheProblem />
                </article>

                {/* Solution/How It Works Section */}
                <article id="how-it-works" aria-labelledby="solution-heading" itemScope itemType="https://schema.org/HowTo">
                    <TheSolution />
                </article>

                {/* Demos Section */}
                <article id="demos" aria-labelledby="demos-heading" itemScope itemType="https://schema.org/VideoGallery">
                    <Demos />
                </article>

                {/* Process Section */}
                <article id="process" aria-labelledby="process-heading" itemScope itemType="https://schema.org/HowTo">
                    <TheProcess />
                </article>

                {/* ROI Calculator */}
                <aside id="roi" aria-labelledby="roi-heading" itemScope itemType="https://schema.org/WebApplication">
                    <ROICalculator />
                </aside>

                {/* Languages Section */}
                <article id="languages" aria-labelledby="languages-heading">
                    <LanguageMap />
                </article>

                {/* Testimonials Section */}
                <article id="testimonials" aria-labelledby="testimonials-heading" itemScope itemType="https://schema.org/Review">
                    <SocialProof />
                </article>

                {/* Pricing Section */}
                <article id="pricing" aria-labelledby="pricing-heading" itemScope itemType="https://schema.org/OfferCatalog">
                    <Pricing />
                </article>

                {/* Why Voxzen Section */}
                <article id="why-us" aria-labelledby="why-us-heading">
                    <WhyVoxzen />
                </article>

                {/* Application Form Section */}
                <section id="apply" aria-labelledby="apply-heading" itemScope itemType="https://schema.org/ContactPage">
                    <ApplicationForm />
                </section>

                {/* FAQ Section */}
                <article id="faq" aria-labelledby="faq-heading" itemScope itemType="https://schema.org/FAQPage">
                    <FAQ />
                </article>
            </Suspense>
        </>
